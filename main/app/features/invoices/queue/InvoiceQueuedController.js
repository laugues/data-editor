    ...
    .controller('InvoiceQueuedController', [
        ...
        function ($scope, globalConstants, itPopup, InvoiceService, $translate, $window) {
            ...
            $scope.masterDetails = {
                columnDefs: [
                    {
                        field: 'UpdateDocumentMessage.DocumentIdentificationData.ItesoftId',
                        ...
                        field: 'UpdateDocumentMessage.DocumentIdentificationData.BusinessGroup',
                    ...
                    {
                        field: 'UpdateDocumentMessage.DocumentIdentificationData.BATCHNAME',
                    ...
                    {
                        field: 'UpdateDocumentMessage.DocumentIdentificationData.SCANDATE',
            ...
            function _itesoftIdFromItem(item) {
                ...
                if (
                    item != null &&
                    item.UpdateDocumentMessage != null &&
                    item.UpdateDocumentMessage.DocumentIdentificationData != null &&
                    item.UpdateDocumentMessage.DocumentIdentificationData.ItesoftId != null
                ) {
                    result = item.UpdateDocumentMessage.DocumentIdentificationData.ItesoftId;
                }
